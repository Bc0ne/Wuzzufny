...
namespace Job_offers.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.UserType = new SelectList(db.Roles.Where(r=>!r.Name.Contains("Admins")).ToList(),"Name","Name");
            return View();
        }
        ...
        public ActionResult EditProfile(EditProfileViewModel profile)
        {
            ...
            {
                ViewBag.Message = "Your Current password isn't correct!";
            }
            else
            {
                var newUserPassword = UserManager.PasswordHasher.HashPassword(profile.NewPassword);
                CurrentUser.UserName = profile.UserName;
                CurrentUser.Email = profile.Email;
                CurrentUser.PasswordHash = newUserPassword;
