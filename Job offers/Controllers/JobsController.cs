...
namespace Job_offers.Controllers
{
    ...
    public class JobsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,JobTitle,JobContent,JobImage,CategoryId")] Job job,HttpPostedFileBase upload)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,JobTitle,JobContent,JobImage,CategoryId")] Job job, HttpPostedFileBase upload)
        {
            if (ModelState.IsValid)
            {
